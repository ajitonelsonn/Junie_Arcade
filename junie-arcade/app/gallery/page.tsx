        ...
        <main className="container mx-auto px-8 pb-32">
          {isLoading ? (
            ...
            <div className="text-center py-20 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-md">
              <p className="text-2xl font-black text-slate-500 uppercase italic">No matches found.</p>
              <p className="text-slate-600 mt-2">Try a different search or win a game to appear here!</p>
            ...
            <div className="space-y-16">
              {!selectedFolder ? (
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-8">
                  {Object.entries(groups).map(([groupKey, userImages], index) => {
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h2 className="text-3xl font-black uppercase italic tracking-tighter text-white">
                          {selectedFolder.split('|')[0]} <span className="text-slate-500 text-sm ml-2 font-black tracking-widest not-italic">({groups[selectedFolder]?.length || 0} Cards)</span>
                        </h2>
