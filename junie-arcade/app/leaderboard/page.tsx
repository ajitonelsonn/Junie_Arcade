          ...
          {heroImages.map((img, i) => (
            <motion.div
              ...
              className={`absolute ${
                ...
                i === 2 ? 'top-[45%] left-[5%]' : 
                i === 3 ? 'top-[65%] right-[2%]' :
                i === 4 ? 'bottom-[15%] left-[8%]' :
                i === 5 ? 'bottom-[25%] right-[15%]' :
                i === 6 ? 'bottom-[45%] left-[2%]' :
                'bottom-[65%] right-[10%]'
              } w-64 h-[400px]`}
            >
              <Image 
        ...
        <header className="px-8 pt-16 pb-12 text-center max-w-5xl mx-auto relative">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#ff4655]">Competitive Integrity Verified</span>
            </div>
            
            <h1 className="text-6xl md:text-9xl font-black mb-6 tracking-tighter leading-none italic uppercase">
              <span className="inline-block text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500">Global</span>
              <br />
              <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-[#ff4655] via-[#ff4655] to-orange-600">Leaderboard</span>
            </h1>
            ...
            <p className="text-xl text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed uppercase tracking-tight">
              ...
              <span className="text-white"> pushing the limits</span> of the <span className="text-[#ff4655]">Junie Arcade Protocol</span>.
            </p>
          </motion.div>
        </header>
