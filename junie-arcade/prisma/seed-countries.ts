...
async function main() {
  ...
  for (const country of countries) {
    try {
      await prisma.country.upsert({
        ...
        update: { code: country.code, flag: country.flag },
        create: country,
      })
      successCount++
      console.log(`✓ Added/Updated ${country.flag} ${country.name} (${country.code})`)
    } catch (error: any) {
  ...
  console.log(`   Added/Updated: ${successCount} countries`)
